...
"use strict";
/* harmony import */ var _src_components_VGrid_VGrid_sass__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(42);
...
const offsetProps = (() => {
  return breakpoints.reduce((props, val) => {
    props['offset' + Object(_util_helpers__WEBPACK_IMPORTED_MODULE_3__[/* upperFirst */ "r"])(val)] = {
      type: [String, Number],
      default: null
    };
    return props;
...
const orderProps = (() => {
  return breakpoints.reduce((props, val) => {
    props['order' + Object(_util_helpers__WEBPACK_IMPORTED_MODULE_3__[/* upperFirst */ "r"])(val)] = {
      type: [String, Number],
      default: null
    };
    return props;
...
var component = Object(componentNormalizer["a" /* default */])(
  ...
  lib_vue_loader_options_pagesvue_type_template_id_6532d677_render,
  staticRenderFns,
  false,
  null,
  null,
...
installComponents_default()(component, {Logo: __webpack_require__(106).default,VuetifyLogo: __webpack_require__(107).default})
